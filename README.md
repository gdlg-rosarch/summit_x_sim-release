## summit_x_sim (kinetic) - 1.1.0-0

The packages in the `summit_x_sim` repository were released into the `kinetic` distro by running `/usr/bin/bloom-release --rosdistro kinetic --track kinetic summit_x_sim --edit` on `Wed, 24 Aug 2016 05:57:57 -0000`
...
## summit_x_sim (indigo) - 1.0.7-0

The packages in the `summit_x_sim` repository were released into the `indigo` distro by running `/usr/bin/bloom-release --rosdistro indigo --track indigo summit_x_sim` on `Wed, 24 Aug 2016 05:39:43 -0000`
